...
<div style="position:relative;height:100px; padding:10px 25px 0 25px;">
	   <div>
         ...
         <div class="menu1"><img onclick="gotoPage('${ctx}/pages/travelzen_order.jsp')" src="${ctx}/images/travelzen_05.jpg" /></div>
         <div class="menu1"><img src="${ctx}/images/travelzen_03.jpg" style="width:190px;" /></div>
