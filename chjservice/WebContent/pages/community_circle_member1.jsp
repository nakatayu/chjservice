...
<div style="position:relative;padding:10px 25px 0 25px;font-family:微软雅黑;">
 ...
 <div style="width:100%;"> 
<table width="100%" style="border-bottom:#F90 3px solid;background-color: #ffffff;" border="0" cellspacing="0" cellpadding="0">
    <tr><td style="background-color:#ffc61a;color:#FFF;font-size:16px;padding:15px 0 15px 15px;font-weight:bold;">圈子成员（50人）</td>
     </tr>
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0" >
             ...
             <tr>
               <td style="font-size:12px;color:#a5a0a0;font-family:微软雅黑;height: 28px;padding: 0 10px 0 0;">简介: 
               <span id="info">${companyInfo.companyInfo}</span></td>
             </tr>
 ...
 <tr>
     <td width="100%" valign="top">
       <table border="0" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr style="color:#ffc61a;">
               <td  colspan="5" onclick="gotoUserDetail(${user.userId},${activityCreateUser.userId})" style="cursor:pointer;padding-left: 5px;height: 35px;" id="nickName">${activityCreateUser.nickName}</td>
             </tr>
  ...
  <tr>
   ...
   <tr>
     <td style="padding:10px 0 10px 20px;color:#7eccce;font-size:16px;">已加入成员</td>
      </tr>
      
      <tr>
      <td>       
      <table id="tbodyPerple" width="100%" border="0" cellspacing="0" cellpadding="0" >
      </table>
      </td>
      </tr>           
    </table>
	     ...
	     success: function(msg,status){
	    	if(msg.status == 200){
	    		...
	    		for(var i=0;i<msg.rows.length;i++){
	    			...
	    			str+='<td valign="top" width="316" align="left" width="100%" style="font-family:微软雅黑;border-bottom:#efefef 1px solid;">';
		    	...
		    	$("#pager").hide();
	    		$('#tbodyPerple').html('<tr><td style="padding-left:25px;color:#7eccce;" heigth="80px">'+msg.msg+'</td></tr>');
		    }	    		
	     }	     
	});
}
