...
<body>
	...
	<form id="odForm" name="odForm" action="https://query-test.sandpay.com.cn/payment/tradition/checkout.do" method="post" target="_black">
		<table>
			<caption align="top" style="font-size: 40px;">订单信息</caption>
			<tr>
				<th>协议版本:</th>
				<td><input type="text" name="version" id="version"
					value="${info.version}" /></td>
			</tr>
			<tr>
				<th>字符编码:</th>
				<td><input type="text" name="charset" id="charset"
					value="${info.charset}" /></td>
			</tr>
			<tr>
				<th>交易类型:</th>
