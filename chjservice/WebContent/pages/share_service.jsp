...
<div style="position:relative;height:100px; padding:10px 25px 0 25px;">
	     ...
	     <div style="float:left;"><img src="${ctx}/images/menu_29.jpg" onclick="gotoPage('${ctx}/pages/share_index.jsp')" /></div>
           <div class="menu1"><img src="${ctx}/images/menu_16.jpg" style="width:190px;"/></div>
...
<script type="text/javascript">
	...
	function findServiceList() {
		pagesize=index+5;
		var param = {serviceType:1,endindex:pagesize,beginindex:index};
			...
			success: function (msg) {
				...
				if (msg.status == 200) {
					...
					for (var i = 0; i < msg.rows.length; i++) {
						...
						array.push('<div class="logo"><a href="${ctx}/pages/share_serviceinfo.jsp?serviceType=1&total='+total+'&serviceId=' + data["service_id"] + '&page='+index+'">');
						array.push('<img alt="'+data["title"]+'"  src="${imageStorePath}'+data["image"]+'" /></a></div>');
						array.push('<div class="tipTitle"><a href="${ctx}/pages/share_serviceinfo.jsp?serviceType=1&total='+total+'&serviceId=' + data["service_id"] + '&page='+index+'">'+title+'</a></div>');
						...
						array.push('<div><span style="float: right">' + data["see_count"] + '</span><img style="float: right" src="${ctx}/images/personal_02.png" />');
						array.push('</div>');
