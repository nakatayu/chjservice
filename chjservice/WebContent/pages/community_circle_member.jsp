...
cursor: pointer;font-size: 16px;width: 100px;border: 1px;
 }
</style>
</head>
...
<tr>
<td width="594" style="padding-right:6px;">
...
<table  width="590"  border="0" cellspacing="0" cellpadding="0" style="background-color: #FFFFFF;border-bottom:#F90 3px solid;">
 ...
 <tr>
 <td style="padding:20px 0 10px 20px;font-family:微软雅黑; color:#7eccce;">
     发起人
 </td>
 </tr>
 <tr>
   ...
   <td width="590" valign="top" >
      ...
      <table width="590"  border="0" cellspacing="0" cellpadding="0" style="background:#fff;">
        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              ...
              <td width="150px" id="methodO">
              <img src="${ctx}/dynamic/photo_delt.png" width="22" height="20" onclick="selectAllPerson_fun(this)" id="selectAllPerson" value="1" style="cursor: pointer;"/>
             
              <span style="color:#7b7b7b;font-family:微软雅黑;padding-left: 20px;">全选</span>
              </td>
              <td width="120px" align="center" id="methodA">
              
              </td>
              <td width="10px" ></td>
              <td width="120px" align="center" id="methodB">
              </td>
              <td width="20px" ></td>
              </tr>
          </table>
...
<tr>
    <td width="20%" height="50px;" valign="middle" style="font-family:微软雅黑;padding:5px 5px 0 40px;">标题:
    </td>
    <td width="80%">
  ...
  <tr>
    <td style="padding:5px 15px 0 40px;height: 50px;font-family:微软雅黑;">内容:</td>    
    <td rowspan="2" valign="top">
      <textarea id="titContent" cols="50" rows="4" style="overflow: hidden;font-size: 16px;height: 80px;"></textarea>
    </td>
  </tr>
  <tr><td style="height: 60px;font-family:微软雅黑;" align="center" valign="top">
 ...
 <td valign="top" style="background:#fff;">  
  ...
  <table id="tabMenu" width="350" border="0" cellspacing="0" cellpadding="0" style="background-color:#ffffff;"> 
     <tr>
...
var circleId="${circleId}";//传参
var crole="${actRoleId}";//传参 ，0成员，1管理员，2圈主
	     ...
	     success: function(msg,status){
	    	if(msg.status == 200){
	    		...
	    		for(var i=0;i<msg.rows.length;i++){
	                ...
	                '<img src="${imageStorePath}'+Tuser["headPicture"]+'" width="73" height="78" /></td>'+
	                ...
	                str+='个人简介：'+info+'</td></tr>'+
	                '<tr><td height="20" style="font-size:14px;font-family:微软雅黑;" align="left">'+
	                '<table width="100%" border="0" cellspacing="0" cellpadding="0">'+
...
function cssTheMenuAndMenu(stat){
	...
	$('#tabMenu td[class^="nextMenu"]').each(function(){
