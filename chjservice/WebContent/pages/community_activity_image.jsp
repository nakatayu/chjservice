...
<style type="text/css">
.btnbuton{
color:#FFF;font-family:微软雅黑; background-color:#FC0; padding: 5px 10px 5px 10px;border: 0px;cursor: pointer;
}
.divMess{
 border-bottom:#e4e4e4 1px solid;width: 100%;overflow:hidden;
}
.div_main{
position:relative;padding:30px 150px 20px 150px;height:100%;overflow:hidden;
...
<div id="main_content" class="main_content">
 ...
 <div class="div_main">
 <div>
 <img id="bigPicture" src=" " width="650px" height="450"  style="border:#CCC 1px solid;" />
 </div>
 ...
 <tr><td style="padding-left: 10px;font-family:微软雅黑;" width="30%" align="left">
 ...
 <td width="30%" align="right" style="padding-right: 10px;font-family:微软雅黑;">
 ...
 <div class="div_main"> 
 <div id="pictUreLisrg" style="font-size: 14px; color: #ffc61a;width: 100%;">
 ...
 <td width="300px" style="color:#999;font-family:微软雅黑;">2013年03月06日18:17 </td>
 <td width="50px">&nbsp;</td>
 </tr>
 ...
 <td valign="top" style="padding: 5px 0 0 10px;font-family:微软雅黑;">回复</td></tr>
 </table> 
 </div>
 ...
 <tr>
    <td colspan="2" style="font-size:20px; font-family:微软雅黑;color:#666;padding:20px 0 0 20px;">说点什么吧</td>
  </tr>
  <tr><td id="optionUser" width="80%" style="color:#666;padding: 0 0 10px 40px;color: red;"></td>
  <td width="20%" align="right" valign="bottom" style="font-family:微软雅黑;padding-right: 25px;" id="countOfWord">0/250字 </td></tr>
   <tr align="center">
    <td height="60"  colspan="2">
    <input type="hidden" id="toActPictId"/>
      <textarea rows="4" cols="50" style="overflow: hidden;font-family:微软雅黑;width: 600px;" id="mainYtext">250字以内</textarea>
     </td></tr>
...
function queryThePicturepeer(pagenum){
	...
	$.ajax({
	     ...
	     success: function(msg,status){
	    	 if(msg.status == 200){
	    		 var data=msg.rows[0];
	    		 $('#bigPicture').attr("src","${imageStorePath}"+data["filePath"]);
	     ...
	     success: function(msg,status){
	    	 if(msg.status == 200){
	    		 ...
	    		 for(var i =0;i<msg.rows.length;i++){
	    			 ...
	    			 str+='<tr><td rowspan="3" valign="top" class="funimg" style="font-family:微软雅黑;padding:5px 0 0 20px;width: 60px;">';
	    			 str+='<img src="${imageStorePath}'+data["headImage"]+'" width="48" height="48" /></td>';
	    			 str+='<td width="80px">发布者：</td> <td width="80px" id="nickName'+data["activityCommentId"]+'">'+data["nickName"]+'</td>';
	    			 str+='<td width="300px" style="color:#999;font-family:微软雅黑;">'+data["commentTime"]+'</td>';
	    			 str+='<td width="50px">&nbsp;</td></tr>';
	    			 if(data["toUserId"]>0){
	    				 str+='<tr><td colspan="3" class="infomaid">';
		    			 str+='<span style="margin: 0 20px 0 -5px;color: #ffc61a;font-family:微软雅黑;">'+data["toNickName"]+'</span>';
		    			 str+=''+data["toContent"]+'</td> <td></td></tr>'; 
	    			 }else{
	    				 str+='<tr><td colspan="3" class="infomaid"></td> <td></td></tr>'; 
	    			 }    			
	    			 str+='<tr> <td colspan="3" heigth="40px" class="infomaid" id="content'+data["activityCommentId"]+'">';
	    			 str+=''+data["content"]+'</td>';
	    			 str+='<td valign="top" align="right" style="padding: 5px 10px 0 10px;font-family:微软雅黑;">';
