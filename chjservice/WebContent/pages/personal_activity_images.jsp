...
.pictimg{
border:#CCC 1px solid;width: 170px;height: 150px;cursor: pointer;
}
.choImg{
...
<div id="main_content" class="main_content">
 ...
 <div style="background-color:#ffc61a; color:#FFF;font-size:14px; font-weight:bold;width: 100%;">
  <div style="width: 800px;text-align:left;float:left;font-size:16px; padding:15px 0 15px 15px;">活动照片</div>
  <span id="allquert" style="float: right;padding-top: 15px;display: none;">
  <a style="margin: 0 0 0 20px;cursor: pointer;" onclick="chooseAllpicture()">全选</a>
  <a style="margin: 0 10px 0 30px;cursor: pointer;" onclick="deleteFromImage(0)">删除</a> </span>
 </div>
 
 <div class="divdiv_main" id="photoList" style="height: 780px;">
...
<div id="pager" style="float:right; height:40px;display: none;" >wedrfghgfd</div>
 ...
 <img src="${ctx}/dynamic/photobig_1.png" class="pictimg"/>
 </div>
...
<tr><td height="40px"><input class="put_css" /></td>
<td><button class="btnbuton" >本地浏览</button></td></tr>
<tr><td height="50px" style="font-size:12px;color: #999;" valign="top">建议400*400pt</td>
<td align="right"><img src="${ctx}/dynamic/photo_submit.png" width="89" height="40" />
</td>
</tr>
</table>
 </div>
	     ...
	     success: function(msg,status){
	    	 if(msg.status == 200){
	    		...
	    		for(var i=0;i<msg.rows.length;i++){
	    			...
	    			str+='<img src="${ctx}'+data["filePath"]+'" class="pictimg" onclick="intoPictureMoreInfo('+t+')"/>';
	    			str+='<div style="height: 25px;width: 170px;padding-top: 10px;">';
	    			if(data["roleUserId"]=='T'){
		    			...
		    			str+='<a style="margin-left: 20px;" onclick="deleteFromImage('+data["activityPhotoId"]+')">删除</a>';
	    			}	    			
...
function intoPictureMoreInfo(actImgId){
	...
	window.location.href="${ctx}/pages/personal_activity_image.jsp?actImgId="+actImgId+"&activityId="+activityId;	
}
