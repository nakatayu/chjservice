	...
	<div id="main_content" class="main_content">
		<div style="position:relative;height:100px; padding:10px 25px 0 25px;">
			<div>
				...
				<div class="menu1"><img src="${ctx}/images/menu_18.jpg" style="width:190px;"/></div>
...
<script type="text/javascript">
	...
	function findServiceList() {
		pagesize=index+5;
		var param = {serviceType:2,endindex:pagesize,beginindex:index};
			...
			success: function (msg) {
				...
				if (msg.status == 200) {
					...
					for (var i = 0; i < msg.rows.length; i++) {
						...
						array.push('<div class="logo"><a href="${ctx}/pages/share_serviceinfo.jsp?serviceType=2&total='+total+'&serviceId=' + data["service_id"] + '&page='+index+'">');
						array.push('<img alt="'+data["title"]+'"  src="${imageStorePath}'+data["image"]+'" /></a></div>');
						array.push('<div class="tipTitle"><a href="${ctx}/pages/share_serviceinfo.jsp?serviceType=2&total='+total+'&serviceId=' + data["service_id"] + '&page='+index+'">'+title+'</a></div>');
