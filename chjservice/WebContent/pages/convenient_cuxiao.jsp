	     ...
	     success: function(msg,status){
	    	if(msg.status == 200){
	    	   ...
	    	   for(var i=0; i < msg.rows.length; i++){
	    		  ...
	    		  array.push('<div class="brand_pic"><p>促销价：<span class="brand_pictx">￥'+price+'</span></p><p class="lable_title">市场价：<span class="brand_picx">￥'+oldPrice+'</span></p>');
	    	   ...
	    	   if(msg.rows.length==0 && pageinfo["page"]==1){
					...
					$('#div_cuxiao').html('<div style="float:left; margin:10px 25px 0 25px; width:950px; height:40px;line-height:40px;text-align:center;background:#fff; ">'+pageinfo["emtMsg"]+'</div>');
	    	   }
	    	}
	    	else{
	    		alert(msg.msg);
