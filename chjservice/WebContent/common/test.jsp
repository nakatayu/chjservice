...
if(pageCount==0) {
	...
	for (var i = 1; i <= pageCount; i++) {
		if (i == pageNo) {
			...
			strHtml += '<li title="Page ' + i + '"><a href="javascript:void(0)" onclick="gotoPage('+i+')">'+i+'</a>';
		}
	}
}else{
	if(pageNo<=showCount-1) {
		...
		strHtml += '&nbsp;...&nbsp;<a href="javascript:void(0)" onclick="gotoPage('+pageCount+')">'+pageCount+'</a></li>'
	}else if(pageNo>(showCount-1)&&pageNo<pageCount-(showCount-showCount/2)) {
		strHtml += '<li title="Page1"><a href="javascript:void(0)" onclick="gotoPage(1)">1</a>&nbsp;...</li>'
...
if (nextPage > pageCount) {
	...
	strHtml += '<li title="下页"><a href="javascript:void(0)" onclick="gotoPage('+nextPage+')">></a></li>';
}
